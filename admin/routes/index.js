...
router.get('/photos/find/:id', async function(req, res, next) {
  ...
  //response.data.url = 'http://localhost:4444/'+response.data.ruta.replace('public/','')

  //const foto= response.data
 res.render('formulario_update', { title: 'Update', foto: response.data[0]});
